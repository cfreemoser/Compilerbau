 ...
 ******************************************************************************/
/* Here we define out First Follow Set */
...
/* we define our Nonterminals */
static bool f_E1 (void);
static bool f_T  (void);
static bool f_T1 (void);
static bool f_F  (void);

/* we define our productions */
bool f_E (void)
{
  DEBUG_show("E");

  /* When the input starts with ( or id then we look wether it is a T and an E1*/
  if (FirstFollow_1()) return f_T() && f_E1();
  
  /* It is not part of our langueage*/
